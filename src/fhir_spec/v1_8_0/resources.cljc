(ns fhir-spec.v1-8-0.resources
  (:require #?(:clj  [clojure.spec.alpha :as s]
               :cljs [cljs.spec.alpha :as s])))
;; Copy-paste from 3.0.1, but with little according corrections
...
(s/def ::careProvider (s/* (s/keys :req-un [:fhir-spec.3.0.1.resources.Person.generalPractitioner/reference])))
